...
public class ServerListener implements Listener {
    ...
    public void received(Connection c, Object o) {
        ...
        if (o instanceof Network.StopPlayerMove) {
            ...
            if (rm.containsInRoom(c)) rm.getRoomFor(c).cancleMove((Network.StopPlayerMove) o, c);
            else if (rm.containsInDungeon(c)) rm.getDungeonFor(c).cancleMove((Network.StopPlayerMove) o, c);
            else if (rm.containsIn1v1(c)) rm.getRoomFor1vs1(c).cancleMove((Network.StopPlayerMove) o, c);
        }
        ...
        if (o instanceof Network.AttackStartPacket) {
            ...
            else if (rm.containsIn1v1(c)) rm.getRoomFor1vs1(c).startAttack((Network.AttackStartPacket) o);
        }
        ...
        if (o instanceof Network.AttackReleasePacket) {
            ...
            else if (rm.containsIn1v1(c)) rm.getRoomFor1vs1(c).endAttack((Network.AttackReleasePacket) o);
        }
        ...
        if (o instanceof Network.AttackDragged) {
            ...
            else if (rm.containsIn1v1(c)) rm.getRoomFor1vs1(c).attackDragged((Network.AttackDragged) o);
        }

        if(o instanceof  Network.PvpRequest){
            rm.getRoomFor(c).handlePvpRequest((Network.PvpRequest) o, c);
        }
    }
}
